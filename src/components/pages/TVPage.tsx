...
export default function TVPage() {
  ...
  // Fetch TV Shows on filter change
  useEffect(() => {
    async function fetchTV() {
      ...
      try {
        ...
        // Fix: Filter out unreleased shows when sorting by newest
        ...
        if (selectedYear !== 'all') params.first_air_date_year = parseInt(selectedYear);
    ...
    <div className="container mx-auto px-4 py-12 pb-20">
      <div className="flex flex-col gap-6 mb-8">
        <div className="flex justify-between items-center">
          <h1 className="text-3xl font-bold">Explore TV Series</h1>
          {/* Reset Button */}
          <Button 
            variant="ghost" 
            size="sm" 
